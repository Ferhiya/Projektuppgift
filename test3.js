...
var knappar2; //refens till tryckt knapp
var display;
var vatteninfo;
var adinfo;
var valt;
...
function init() {
	...
	valt2=document.getElementById("vattenv2");
    valt=document.getElementById("vattenv3");
	knappar2=document.getElementsByClassName("dropbtn2");
    //knappar3=document.getElementsByClassName("knappar2");
    display=document.getElementById("vandringslederna");
    valt3=document.getElementById("aderalinv");
 console.log("hej");
	for (let i = 0; i < knappar2.length; i++) {
        //för vattem
		knappar2[i].addEventListener("click", requestData2);
        knappar2[i].addEventListener("click", requestJSONData2);
        knappar2[i].addEventListener("click", showledinfo2);

        //för aderalin
        knappar2[i].addEventListener("click", requestJSONData);
        knappar2[i].addEventListener("click", showledinfo);
...
function requestJSONData2(e) { 
    // let id = e.target.id;
     ...
     request.onreadystatechange = function () { //funktion för att avläsa kommunikation i filenhämtningen
         if (request.readyState == 4) //staus 4=kommunikation klar
             if (request.status == 200) getJSONData2(request.responseText, cityname); //Status ok=filen finns. responseText=för att man hämtar en JSON fil.
 ...
 // Tolkar koden och skriv ut den på önskad form
 function getJSONData2(JSONtext,cityname) {
 ...
 function getData2(JSONtext,btn,cityname){
     ...
     x.style.visibility="visible";
        ...
        x.addEventListener("click", requestJSONData2);
        x.addEventListener("click", showledinfo2);
 for (let i = 0; i < vatten.length; i++) {
...
function requestJSONData(e) { 
    ...
    // let id = e.target.id;
     ...
     request.onreadystatechange = function () { //funktion för att avläsa kommunikation i filenhämtningen
         if (request.readyState == 4) //staus 4=kommunikation klar
             ...
             else valt3.innerHTML = "Den begärda filen finns inte."; //error msg när begärd fil inte finns
     };
 ...
 function getJSONData(JSONtext,cityname) {
     ...
     for (let i = 0; i < aderalin.length; i++) {
         ...
         valt3.innerHTML = HTMLcode5; //utskrift av datan i JSON filen
         valt3.style.fontSize = "150%";
         valt3.style.visibility="visable";
         valt3.style.marginBottom = "5%";
         //document.getElementById("unordered").style.border= "2px solid black";
     ...
     clearcontent(display);
         ...
         valt.innerHTML= HTMLcode5;//utskrift av datan i JSON filen
         //li.style.display=" flex";
